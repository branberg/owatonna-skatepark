...
<head>
	<meta charset="utf-8">
	<title>Owatonna Skate Park | Draft</title>
	...
	<div id="wrapper">
		...
		<div id="main">
			<section id="intro">
				...
				<span>The park is open to all sports with wheels, and some without (think middle of winter dare-devil snowboard craziness).</span>
			</section>
			<section id="photos">
		...
		<footer>
			<h6>&copy; 2012 | Site Created By <a href="http://branberg.com" target="_blank">Branberg</a></h6>
		</footer>
	</div>
